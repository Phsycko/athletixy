    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-6 py-3 bg-dark-800 hover:bg-dark-700 text-white rounded-lg transition border border-dark-600">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-white text-sm font-semibold">{producto.rating}</span>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-6 text-center">
          ...
          <h3 className="text-white font-semibold mb-2">Envío Gratis</h3>
          <p className="text-gray-400 text-sm">En compras mayores a $1000</p>
        </div>
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-6 text-center">
          <div className="bg-blue-500/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
            <Star className="w-6 h-6 text-blue-400" />
          </div>
          <h3 className="text-white font-semibold mb-2">Calidad Premium</h3>
          <p className="text-gray-400 text-sm">Productos verificados y certificados</p>
        </div>
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-6 text-center">
          <div className="bg-purple-500/10 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
            <ShoppingBag className="w-6 h-6 text-purple-400" />
          </div>
          <h3 className="text-white font-semibold mb-2">Devoluciones Fáciles</h3>
          <p className="text-gray-400 text-sm">30 días para devolver tu compra</p>
        </div>
      </div>
    </div>
  )
