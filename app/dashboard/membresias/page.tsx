...
export default function MembresiasPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-white mb-2">Membresías</h1>
        <p className="text-gray-400">Administra tu plan y pagos</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-primary-600 to-purple-600 rounded-xl p-6 shadow-xl">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <h2 className="text-3xl font-bold text-white mb-2">{membresiaActual.plan}</h2>
            <p className="text-white/80">
              ${membresiaActual.precio} <span className="text-sm">/mes</span>
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
            <p className="text-white/80 text-sm">Vence en</p>
            <p className="text-2xl font-bold text-white">{diasRestantes}</p>
            <p className="text-white/80 text-sm">días</p>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            <p className="text-white/60 text-sm mb-1">Inicio</p>
            <p className="text-white font-medium">{membresiaActual.fechaInicio}</p>
          </div>
          <div>
            <p className="text-white/60 text-sm mb-1">Vencimiento</p>
            <p className="text-white font-medium">{membresiaActual.fechaVencimiento}</p>
          </div>
        </div>

        <div className="flex items-center justify-between p-3 bg-white/10 backdrop-blur-sm rounded-lg">
          <span className="text-white text-sm">Renovación automática</span>
      ...
      {/* Planes Disponibles */}
      <div>
        <h2 className="text-lg font-semibold text-white mb-6">Planes Disponibles</h2>
          ...
          {historialPagos.map((pago, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white font-medium">${pago.monto}</p>
              ...
              <div className="text-right">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-gray-400 text-sm">{pago.fecha}</span>
                </div>
