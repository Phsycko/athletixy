...
export default function SoportePage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-black mb-2">Soporte</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-gray-600 transition cursor-pointer">
          ...
          <h3 className="text-black font-semibold mb-2">Chat en Vivo</h3>
          <p className="text-gray-600 text-sm mb-4">Respuesta inmediata de nuestro equipo</p>
          <button className="text-gray-700 text-sm font-medium hover:text-primary-300 transition">
            Iniciar chat →
          </button>
        </div>
        ...
        <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-gray-600 transition cursor-pointer">
          ...
          <p className="text-gray-600 text-sm mb-4">soporte@athletixy.com</p>
          <button className="text-gray-700 text-sm font-medium hover:text-primary-300 transition">
            Enviar email →
          </button>
        </div>
        ...
        <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-gray-600 transition cursor-pointer">
          ...
          <h3 className="text-black font-semibold mb-2">Teléfono</h3>
          <p className="text-gray-600 text-sm mb-4">+52 55 1234 5678</p>
          <button className="text-gray-700 text-sm font-medium hover:text-primary-300 transition">
            Llamar ahora →
          </button>
        </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="flex items-center gap-2 px-6 py-3 bg-black hover:bg-gray-800 text-white rounded-lg transition font-medium shadow-lg"
          >
        ...
        <div className="space-y-4">
          {preguntasFrecuentes.map((faq, index) => (
            ...
            >
              ...
              <div className="px-4 pb-4 text-gray-600 text-sm border-t border-gray-300 pt-3">
                {faq.respuesta}
              </div>
            </details>
          ))}
